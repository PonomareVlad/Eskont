...
function initSwiper(slider, photoSwipeInit = true) {
    ...
    })) && photoSwipeInit ? initPhotoSwipeFromDOM(".my-gallery") : true;
}
...
var initPhotoSwipeFromDOM = function (gallerySelector) {
    ...
    var openPhotoSwipe = function (
        ...
        gallery.listen("unbindEvents", function () {
            ...
            for (var i = 0, len = swiperSliders.length; i < len; i++) swiperSliders[i].slideTo(getCurrentIndex, false); //TODO: Trigger only active slider
